...
from .views import PurchaseOrderListView, PurchaseOrderDetailViev, PurchaseOrderUpdateView, \
    ...
    PurchaseOrderConfirmationFileView
...
urlpatterns = [
    ...
    path('purchase-orders/<str:pk>/confirmation/filedownload/', PurchaseOrderConfirmationFileView.as_view(), name='purchase_order_confirmation_file'),
