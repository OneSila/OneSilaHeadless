...
class ContactsMutation:
    ...
    delete_address: AddressType = delete()
    delete_addresses: List[AddressType] = delete()
    ...
    update_shipping_address: ShippingAddressType = update(ShippingAddressPartialInput)
    ...
    update_invoice_address: InvoiceAddressType = update(InvoiceAddressPartialInput)
