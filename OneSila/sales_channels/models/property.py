...
class RemoteProperty(PolymorphicModel, RemoteObjectMixin, models.Model):
    ...
    """
    local_instance = models.ForeignKey('peropeties.Property', on_delete=models.CASCADE, help_text="The local property associated with this remote property.")

    class Meta:
        unique_together = ('sales_channel', 'property')
...
class RemoteProductProperty(PolymorphicModel, RemoteObjectMixin, models.Model):
    ...
    """
    local_instance = models.ForeignKey('attributes.ProductProperty', on_delete=models.CASCADE, help_text="The local ProductProperty instance associated with this remote property.")
