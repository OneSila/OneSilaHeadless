...
@input(EbayInternalPropertyOption, fields="__all__")
class EbayInternalPropertyOptionInput:
    pass


@partial(EbayInternalPropertyOption, fields="__all__")
class EbayInternalPropertyOptionPartialInput(NodeInput):
    pass
