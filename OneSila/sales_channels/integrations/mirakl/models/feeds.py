...
class MiraklSalesChannelFeed(SalesChannelFeed):
    ...
    conversion_type = models.CharField(max_length=64, blank=True, default="")
    conversion_options_ai_enrichment_enabled = models.BooleanField(default=False)
    conversion_options_ai_rewrite_enabled = models.BooleanField(default=False)
    integration_details_invalid_products = models.PositiveIntegerField(default=0)
    integration_details_products_not_accepted_in_time = models.PositiveIntegerField(default=0)
    integration_details_products_not_synchronized_in_time = models.PositiveIntegerField(default=0)
    integration_details_products_reimported = models.PositiveIntegerField(default=0)
    integration_details_products_successfully_synchronized = models.PositiveIntegerField(default=0)
    integration_details_products_with_synchronization_issues = models.PositiveIntegerField(default=0)
    integration_details_products_with_wrong_identifiers = models.PositiveIntegerField(default=0)
    integration_details_rejected_products = models.PositiveIntegerField(default=0)
