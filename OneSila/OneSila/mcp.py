...
mcp = FastMCP(
    name="OneSila",
    instructions=(
        "This server provides company-scoped access to OneSila property management tools. "
        "Use read tools to inspect properties, property values, and company languages. "
