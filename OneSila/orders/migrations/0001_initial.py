    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('PENDING_PROCESSING', 'Pending Processing'), ('PENDING_SHIPPING_APPROVAL', 'Pending Shipping Approval'), ('TO_SHIP', 'To Ship'), ('AWAIT_INVENTORY', 'Awaiting Inventory'), ('SHIPPED', 'Shipped'), ('CANCELLED', 'Cancelled'), ('HOLD', 'On Hold')], default='DRAFT', max_length=32)),
                ('reason_for_sale', models.CharField(choices=[('SALE', 'Sale'), ('SAMPLE', 'Commercial Sample'), ('GIFT', 'Gift')], default='SALE', max_length=10)),
