# Generated by Django 5.2 on 2025-06-20 20:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_emails', models.JSONField(blank=True, default=list, help_text='List of external emails that will receive a report.')),
                ...
                ('import_process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='imports_exports.import')),
                ...
                ('users', models.ManyToManyField(blank=True, help_text='Internal users that will receive a report.', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
