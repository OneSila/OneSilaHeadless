...
inspector_undecided_sales_channel_views_failed = ModelSignal(use_caching=True)
inspector_undecided_sales_channel_views_success = ModelSignal(use_caching=True)
