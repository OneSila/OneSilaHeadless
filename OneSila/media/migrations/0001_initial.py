    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='images/', validators=[core.validators.validate_image_extension], verbose_name='Image (High resolution)')),
                ('image_hash', models.CharField(blank=True, max_length=100, null=True, verbose_name='image hash')),
                ('file', models.FileField(blank=True, null=True, upload_to='files/', validators=[core.validators.validate_file_extensions, core.validators.no_dots_in_filename], verbose_name='File')),
